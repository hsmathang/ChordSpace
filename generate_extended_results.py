"""
generate_extended_results.py
---------------------------
Adapts the modern `ExperimentService` to run the extended 81-chord C3 anchored 
population via the "perclass_alpha0_75" roughness proposal and generates `report.html`.
"""
...
OUTPUT_DIR = ROOT / "experiments" / "triad_consonance" / "outputs" / "reporte_extendida"
...
def main() -> None:
    ...
    rough_config = RoughnessConfig(
        proposals=["perclass_alpha0_75"],  # Propuesta solicitada por el usuario
    ...
    vis_config = VisualizationConfig(
        sections=["scatter", "heatmap", "table", "metadata", "shepard"],
