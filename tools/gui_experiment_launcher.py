...
class ExperimentLauncher(tk.Tk):
    ...
    def _on_run_clicked(self) -> None:
        ...
        if not selected_ids and df_override is None:
            if not pops and not base_query and not self.filter_enable_var.get():
                messagebox.showwarning(
                    "Parámetros insuficientes",
                    "Selecciona una consulta base, agrega poblaciones conjuntas o activa los filtros personalizados.",
                )
                return
        ...
        if selected_ids:
            ...
            log_parts = []
            if base_query:
                log_parts.append(f"Consulta base: {base_query}")
            if pops:
                log_parts.append("Poblaciones conjuntas: " + ", ".join(pops))
