"""
exp_umap_cosine_estructuras_extendidas_c3.py
============================================
Versión del experimento de estructuras extendidas adaptado explícitamente 
para usar UMAP con distancia COSENO y la propuesta perclass_alpha0_75.
Guarda resultados en una subcarpeta de:
  experiments/triad_consonance/outputs/estructuras_extendidas_c3_umap_cosine
"""
...
OUTPUT_DIR = Path(__file__).parent / "outputs" / "estructuras_extendidas_c3_umap_cosine"
...
def main():
    ...
    print(f"[INFO] Lanzando pipeline UMAP (COSINE) a la carpeta {OUTPUT_DIR}...")
    ...
    metrics_single = run_experiment(
        ...
        experiment_name="Acordes_Extendidas_C3_UMAP_Csn",
        scatter_title="Estructuras Extendidas en C3 (UMAP Coseno)",
        n_init=1,
